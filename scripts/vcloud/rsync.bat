...
powershell -Command "(New-Object System.Net.WebClient).DownloadFile('http://ftp.inf.tu-dresden.de/software/windows/cygwin32/x86_64/release/rsync/rsync-3.1.0-1.tar.xz', 'C:\Windows\Temp\rsync-3.1.0-1.tar.xz')" <NUL
